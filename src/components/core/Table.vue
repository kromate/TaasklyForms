<template>
	<div class="w-full sm:border border-dark overflow-x-hidden text-dark">
		<slot name="option" />
				...
				<thead class="px-4">
					<tr class="h-[52px] border-b px-4">
						...
						<th
							...
							:key="i"
							class="uppercase text-sm  font-bold text-left px-4"
							:class="[headerClass ? headerClass : 'bg-dark text-light']"
