<template>
	<div class="tab-body  border-dark hide-scrollbar">
...
.tab-item {
    @apply text-grey_two cursor-pointer flex-1 justify-center text-center font-medium bg-transparent transition-opacity duration-500 ease-linear capitalize py-1.5 px-5 whitespace-nowrap;
}

.active {
    @apply opacity-100 rounded-md border border-dark  text-primary bg-light;
}
</style>
